...
```php
//...
use srag\RemovePluginDataConfirm\AssessmentTest\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\AssessmentTest\x\RepositoryObjectPluginUninstallTrait;
//...
