...
/**
 * Class ilObjAssessmentTestAccess
 *
...
class ilObjAssessmentTestAccess extends ilObjectPluginAccess
{
    ...
    /**
     * ilObjAssessmentTestAccess constructor
     */
    ...
    {
        ilUtil::sendFailure(self::plugin()->translate("permission_denied", ilObjAssessmentTestGUI::LANG_MODULE_OBJECT), true);
    ...
    {
        $object_settings = self::assessmentTest()->objectSettings()->getObjectSettingsById(intval($a_obj_id));
