...
/**
 * Class ilAssessmentTestConfigGUI
 *
...
class ilAssessmentTestConfigGUI extends ilPluginConfigGUI
{
    ...
    /**
     * ilAssessmentTestConfigGUI constructor
     */
    ...
    protected function setTabs()/*: void*/
    {
        ...
        self::dic()->locator()->addItem(ilAssessmentTestPlugin::PLUGIN_NAME, self::dic()->ctrl()->getLinkTarget($this, self::CMD_CONFIGURE));
    }
    ...
    protected function configure()/*: void*/
    {
        ...
        $form = self::assessmentTest()->config()->factory()->newFormInstance($this);
